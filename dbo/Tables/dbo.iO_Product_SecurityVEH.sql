CREATE TABLE [dbo].[iO_Product_SecurityVEH]
(
...
[RSC_RegoRenewal] [datetime] NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
ALTER TABLE [dbo].[iO_Product_SecurityVEH] ADD CONSTRAINT [PK_iO_Product_SecurityVEH] PRIMARY KEY CLUSTERED  ([RSC_ID]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
EXEC sp_addextendedproperty N'MS_Description', N'Primary Key.', 'SCHEMA', N'dbo', 'TABLE', N'iO_Product_SecurityVEH', 'COLUMN', N'RSC_ID'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Used to compare records in Replication process.', 'SCHEMA', N'dbo', 'TABLE', N'iO_Product_SecurityVEH', 'COLUMN', N'RSC_IDLink_Version'
GO
EXEC sp_addextendedproperty N'MS_Description', N'Redundant.', 'SCHEMA', N'dbo', 'TABLE', N'iO_Product_SecurityVEH', 'COLUMN', N'RSC_Ownership'
GO
