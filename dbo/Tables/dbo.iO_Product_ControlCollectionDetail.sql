...
GO
ALTER TABLE [dbo].[iO_Product_ControlCollectionDetail] ADD CONSTRAINT [PK__iO_Produ__D97BDFFA1077C589] PRIMARY KEY CLUSTERED  ([RCCd_ID]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
