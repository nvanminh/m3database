CREATE TABLE [dbo].[iO_Control_ProfileGroup15]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup15] ADD CONSTRAINT [io_control_profilegroup15_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
