CREATE TABLE [dbo].[iO_Control_ProfileGroup09]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup09] ADD CONSTRAINT [iio_control_profilegroup09_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
