CREATE TABLE [dbo].[iO_Control_FormMaster15]
(
...
GO
ALTER TABLE [dbo].[iO_Control_FormMaster15] ADD CONSTRAINT [iO_Control_FormMaster151_PrimaryKey] PRIMARY KEY CLUSTERED  ([XFRM_ID]) ON [PRIMARY]
GO
