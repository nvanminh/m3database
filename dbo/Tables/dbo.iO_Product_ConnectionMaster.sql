...
GO
ALTER TABLE [dbo].[iO_Product_ConnectionMaster] ADD CONSTRAINT [PK__iO_Produ__585DAD775D527A49] PRIMARY KEY CLUSTERED  ([RCONm_ID]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
