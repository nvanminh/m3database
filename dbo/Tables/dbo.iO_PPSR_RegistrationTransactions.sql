...
GO
ALTER TABLE [dbo].[iO_PPSR_RegistrationTransactions] ADD CONSTRAINT [PK__iO_PPSR___4F215DD6459971CA] PRIMARY KEY CLUSTERED  ([PPSrt_ID]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
