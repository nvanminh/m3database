CREATE TABLE [dbo].[iO_Control_ProfileGroup04]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup04] ADD CONSTRAINT [io_control_profilegroup04_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
