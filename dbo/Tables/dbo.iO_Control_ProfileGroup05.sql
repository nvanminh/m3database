CREATE TABLE [dbo].[iO_Control_ProfileGroup05]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup05] ADD CONSTRAINT [io_control_profilegroup05_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
