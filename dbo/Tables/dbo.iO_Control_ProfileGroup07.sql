CREATE TABLE [dbo].[iO_Control_ProfileGroup07]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup07] ADD CONSTRAINT [io_control_profilegroup07_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
