CREATE TABLE [dbo].[iO_Control_ProfileGroup_Stated_Liabilities_to_Liabilities]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup_Stated_Liabilities_to_Liabilities] ADD CONSTRAINT [iO_Control_ProfileGroup_Stated_Liabilities_to_Liabilities_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
