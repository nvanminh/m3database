...
GO
ALTER TABLE [dbo].[iO_PPSR_RegistrationRequestDet] ADD CONSTRAINT [PK__iO_PPSR___D130611581E09306] PRIMARY KEY CLUSTERED  ([PPSrr_ID]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
