CREATE TABLE [dbo].[iO_Control_ProfileGroup08]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup08] ADD CONSTRAINT [io_control_profilegroup08_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
