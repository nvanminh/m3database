CREATE TABLE [dbo].[iO_Control_ProfileGroup17]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup17] ADD CONSTRAINT [io_control_profilegroup17_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
