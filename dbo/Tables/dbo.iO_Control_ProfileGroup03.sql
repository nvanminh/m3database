CREATE TABLE [dbo].[iO_Control_ProfileGroup03]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup03] ADD CONSTRAINT [io_control_profilegroup03_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
