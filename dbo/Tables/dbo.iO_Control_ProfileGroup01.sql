CREATE TABLE [dbo].[iO_Control_ProfileGroup01]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup01] ADD CONSTRAINT [io_control_profilegroup01_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
