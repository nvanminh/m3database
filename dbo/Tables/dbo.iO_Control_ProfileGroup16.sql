CREATE TABLE [dbo].[iO_Control_ProfileGroup16]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup16] ADD CONSTRAINT [io_control_profilegroup16_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
