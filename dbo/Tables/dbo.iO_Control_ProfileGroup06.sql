CREATE TABLE [dbo].[iO_Control_ProfileGroup06]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup06] ADD CONSTRAINT [io_control_profilegroup06_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
