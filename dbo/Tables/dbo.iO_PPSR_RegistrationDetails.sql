...
GO
ALTER TABLE [dbo].[iO_PPSR_RegistrationDetails] ADD CONSTRAINT [PK__iO_PPSR___EBC2F429697B8CE5] PRIMARY KEY CLUSTERED  ([PPSrd_ID]) WITH (FILLFACTOR=85) ON [PRIMARY]
GO
