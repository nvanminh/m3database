CREATE TABLE [dbo].[iO_Control_ProfileGroup12]
(
...
GO
ALTER TABLE [dbo].[iO_Control_ProfileGroup12] ADD CONSTRAINT [io_control_profilegroup12_PrimaryKey] PRIMARY KEY CLUSTERED  ([XPFg_ID]) ON [PRIMARY]
GO
