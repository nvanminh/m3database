...
CREATE PROC [dbo].[spr_ETLTranformClientInfo]
AS
BEGIN
	...
	(
		...
		-- Bank Account Info
		CB.CBD_ID AS BankAccountID, (ISNULL(CB.CBD_AccountNumber,'') + ':' + ISNULL(CB.CBD_AccountBSBNo,'')) AS BankAccount, REPLACE(LOWER(CB.CBD_AccountName),' ','') AS AccountName,
		-- Address Infor
